...
<head>
<meta charset="utf-8">
<title>Doctors & Respective Joining Dates</title>
</head>
...
<div class="logo">
  ...
  <h2 style="text-align: center;margin-top: 6%;font-family: fantasy;">Doctors & Respective Joining Dates</h2>
...
include("config.php");
$s=1;
$sql="select name,deptname,joindate from tbldoctor d inner join tbldepartment de on d.deptid=de.deptid order by deptname ";
$res=mysqli_query($con,$sql);
   while($display=mysqli_fetch_array($res))
   {
	...
	<tr>
                          ...
                          <td> <?php echo $display["joindate"];?></td>
