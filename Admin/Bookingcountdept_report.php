...
<body>
<form action="Excel/excel_Bookingcountdept_report.php" method="post">
<div class="logo">
              <a href="./index.php">
                <br> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
  ...
  <h2 style="text-align: center;margin-top: 6%;font-family: fantasy;">Pie Chart showing the Count of Patients under Each Department</h2>
...
include("config.php");
$s=1;
$sql="SELECT deptname,count(*) as bookingcount FROM tblopdetails op inner join tbldepartment d on op.departmentid=d.deptid  group by deptname ";
