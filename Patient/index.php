                    ...
                    <div class="row">
                        ...
                        <!-- <h4> OP NUMBER : </h4> -->
                            <div class="hero__caption">
                                ...
                                <a href="consultingdetails.php" class="btn hero-btn" data-animation="fadeInLeft" data-delay="0.5s">Consulting Details<i class="ti-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>          
