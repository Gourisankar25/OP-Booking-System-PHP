...
<body>
    ...
    <?php
        ...
        $sql = mysqli_query($con, "SELECT * from tblpatient p 
        inner join tbldistrict d on p.district=d.districtid
                ...
                <div class="card" style="background-image: linear-gradient(to right, #6a8ec8, white 50%);">
                    <div class="card-body" >
                        <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <h4 class="text-secondary mb-1">Patient Name</h4>
                                <h4><?php echo $display["patientname"] ?></h4>
                                
                                <h4 class="text-secondary mb-1">Place</h4>
                                
                                <h4><?php echo $display["districtname"] ?></h4>
              ...
              <div class="card mb-3" style="background-image: linear-gradient(to right,white 50%, #6a8ec8 );">
                <div class="card-body" style="padding: 20px;"  >
                  <div class="row">
                    ...
                    <h4><input type="textbox" value="<?php echo $display["patientname"] ?>" name="patientname" required></h4>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <h4> 
                    <input type="number" id="quantity" value="<?php echo $display["contact"] ?>" name="contact" maxlength="10" && minlength="10" required>
                      <!-- <input type="number" value="<?php echo $display["contact"] ?>" name="contact"  maxlength="10" && minlength="10"  required> -->
                    </h4>
                    </div>
                  </div>
                  <hr>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                    <h4><input type="textbox" value="<?php echo $display["housename"] ?>" name="housename" required></h4>
                    </div>
                  </div>
                  <hr>
                   <!-- <div class="row">
